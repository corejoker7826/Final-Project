...
REM
REM Generated by Vivado on Tue Aug 04 13:57:49 +0530 2026
...
echo "xvlog --incr --relax -prj tb_axi_slave_vlog.prj"
call xvlog  --incr --relax -prj tb_axi_slave_vlog.prj -log xvlog.log
